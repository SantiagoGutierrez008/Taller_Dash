...
def load_data():
    ...
    # Convierte la columna 'time' al tipo datetime
    df['time'] = pd.to_datetime(df['time'], format='%Y-%m-%d %H:%M:%S')  # Ajusta el formato si es necesario
    
    # Establece la columna 'time' como el índice del DataFrame
